package com.azatberdimyradov.dictionaryyt.feature_dictionary.data.repository
...
class WordInfoRepositoryImpl(
    ...
    override fun getWordInto(word: String): Flow<Resource<List<WordInfo>>> = flow {
        ...
        val wordInfos = dao.getWordInfos(word).map { it.toWordInto() }
        ...
        val newWordInfos = dao.getWordInfos(word).map { it.toWordInto() }
